...
func _ready() -> void:
	...
	new = Wander.new(character, get_node("Character/target"))
	new2 = Wander.new(character2,get_node("Character2/target"))
	new3 = Wander.new(character3,get_node("Character3/target"))
	new4 = Wander.new(character4,get_node("Character4/target"))
	new5 = Wander.new(character5,get_node("Character5/target"))
